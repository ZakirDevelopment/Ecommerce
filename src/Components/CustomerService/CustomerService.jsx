...
import { Container, Grid, Typography, Card, CardMedia, CardContent, Button, TextField, RadioGroup, FormControlLabel, Radio } from '@mui/material';
...
const CustomerCareService = () => {
  ...
  return (
    <Container>
      ...
      <Typography variant="body1" paragraph style={{ marginBottom: '40px', textAlign: 'center' }}>
      ...
      <div className="heading">
        <div className="heading">  
          <h1 className='text' style={{ marginTop: '40px', textAlign: 'center' }}>Students details here</h1>
        </div>
      </div>
